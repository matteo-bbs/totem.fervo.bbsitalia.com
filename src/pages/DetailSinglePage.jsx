...
import Documenti from "../components/UI/Documenti.jsx";
import {Card} from "../components/subpage/Card.jsx";

export const DetailSinglePage = () => {
                ...
                <>
                    <div className="h-50vh relative">
                        <div className="flex flex-wrap h-[28vh] content-center relative overflow-hidden top-0 z-10">
                            <div className="absolute inset-0 flex justify-start items-center pl-8 pr-8"></div>
                        </div>
                    ...
                    <div className="text-left p-8 h-[50vh] lg:h-[40vh] overflow-auto">
                        {data?.titolo && (
                            <h1 className="text-fanoBlue font-roboto_slab text-[40px] font-bold mb-10 border-b-2 border-[#335083]">
                                {data.titolo}
                            </h1>
                        )}
                    ...
                    <div className="shadow border h-[10vh] border-gray-300 content-center flex flex-wrap items-center p-8">
                        <BackButtonWhite sfondo={"true"} />
                    </div>
                </>
            )}
