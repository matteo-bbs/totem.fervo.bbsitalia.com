...
export const TotemInterattivi = () => {
    const [data, setData] = useState([]);
    const currentLanguage = localStorage.getItem('lang');
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_APP_BACKEND_URL}/api/pagina-sezione/11`)
    ...
    return(
        <section id={'section-page'} className={'h-screen overflow-hidden'}>
            ...
            <div className={'flex flex-wrap justify-start items-start mt-0 py-5 px-8 h-[62vh] w-full'}>
                <Card page={'totem-interattivi'}/>
            </div>
            {/*    <div className={'flex flex-wrap justify-start items-start mt-0 py-5 px-8 h-[66vh] w-full'}>*/}
            {/*        <Card/>*/}
            {/*    </div>*/}
